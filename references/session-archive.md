...
Separate learner statements from tutor inference. An explicit learner statement is authoritative. A feedback preference inferred from repeated observed learner responses may be recorded as provisional only with its source or evidence. Reconfirm drift-prone facts such as deadlines, available time, goals, and project requirements rather than silently carrying them forever.

Minimize sensitive personal data. Record interests only when they help choose examples, projects, or motivation; do not infer or store sensitive traits or emotions that the learner did not provide for the session.
...
- the learner confirms or changes a goal, deadline, available time, project requirement, explicit feedback preference, interest, tool, or constraint, or repeated observed responses materially change a provisional feedback preference;
